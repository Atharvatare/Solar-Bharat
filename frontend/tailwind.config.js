  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, #0f172a 0%, #1e293b 40%, #1a1a2e 100%)',
      },
      animation: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 20px rgba(245, 158, 11, 0.4), 0 0 60px rgba(245, 158, 11, 0.2)' },
        },
        slideUp: {
      ...
      boxShadow: {
        ...
        'solar': '0 0 20px rgba(245, 158, 11, 0.3)',
        'solar-lg': '0 0 40px rgba(245, 158, 11, 0.4)',
