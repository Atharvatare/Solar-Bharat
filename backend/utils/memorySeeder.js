...
export const seedMemoryDB = async () => {
  try {
    logger.info('🌱 Starting in-memory DB seed...\n');
    ...
    logger.info('🗑️  Cleared existing data in-memory');
    ...
    logger.info('👤 Admin created: admin@solarbharat.com / Admin@123');
    ...
    logger.info('👤 User created: user@solarbharat.com / User@123');
    ...
    logger.info('👤 Unverified user created: new@solarbharat.com / New@1234');
    ...
    logger.info('🏢 Vendor created: SolarTech India');
    ...
    logger.info('\n✅ In-memory DB Seed completed successfully!\n');
  } catch (error) {
    logger.error(`❌ In-memory DB Seed failed: ${error.message}`);
  }
};
